...
syntax match Usage /Keyboard_Pause/
...
syntax match Usage /Keyboard_Volume_Up/
syntax match Usage /Keyboard_Volume_Down/
...
syntax match Usage /Left_Control/
syntax match Usage /Left_Shift/
syntax match Usage /Left_Alt/
syntax match Usage /Left_GUI/
syntax match Usage /Right_Control/
syntax match Usage /Right_Shift/
syntax match Usage /Right_Alt/
